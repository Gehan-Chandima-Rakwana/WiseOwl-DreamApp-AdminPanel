        ...
        <div class="col-md-6">
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">User Role Add</h3>
            ...
            <div class="card-body">
              <!-- <div class="form-group">
                ...
                <input type="text" id="RoleID" class="form-control" value="Role ID">
              </div> -->
              <div class="form-group">
                <label for="inputName"> Role</label>
                <input type="text" id="Role" class="form-control" placeholder="Role" autocomplete='off'>
              </div>
