    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">System Dreams Meaning</h3>
        ...
        <div class="card-body">
            ...
            <div class="col">
              <h3 class="text-primary"><i class="fas fa-paint-brush"></i>System Dream Meaning ID {{ $sysDream->dream_meaning_id }}</h3>
              <p class="text-muted">{{ $sysDream->dream_meaning }}</p>
              <br>
