          ...
          <div class="card card-primary">
            ...
            <div class="card-body">
              <!-- <div class="form-group">
                ...
                <input type="text" id="DreamMeaningID" class="form-control" value="Dream Meaning ID">
              </div> -->

              <div class="form-group">
                <label for="inputDescription">Dream Meaning</label>
                <textarea id="DreamMeaning" class="form-control" rows="20" autocomplete='off'></textarea>
              </div>
<!-- 
              <div class="form-group">
