          ...
          <div class="card card-primary">
            ...
            <div class="card-body">
              <div class="form-group">
                ...
                <input type="text" id="UserID" value="{{ $user->user_id }}" Disabled class="form-control" placeholder="User ID" autocomplete='off'>
              </div>
              <div class="form-group">
                <label for="inputName"> User Email</label>
                <input type="text" id="UserEmail" value="{{ $user->email }}" class="form-control" placeholder="User Email" autocomplete='off'>
              </div>
              <div class="form-group">
                <label for="inputName"> Username</label>
                <input type="text" id="Username" value="{{ $user->username }}" class="form-control" placeholder="Username" autocomplete='off'>
              </div>
              <div class="form-group">
                <label for="inputName">First Name</label>
                <input type="text" id="Fname" value="{{ $user->first_name }}" class="form-control" placeholder="First Name" autocomplete='off'>
              </div>
              <div class="form-group">
                <label for="inputName">Last Name</label>
                <input type="text" id="Lname" value="{{ $user->last_name }}" class="form-control" placeholder="Last Type" autocomplete='off'>
              </div>
              <div class="form-group">
                <label for="inputName">Age</label>
                <input type="text" id="Age" value="{{ $user->age }}" class="form-control" placeholder="Age" autocomplete='off'>
              </div>
              <div class="form-group">
                <label for="inputName">Country</label>
                <input type="text" id="Country" value="{{ $user->country }}" class="form-control" placeholder="Country" autocomplete='off'>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <select class="form-control select2 " name="RoleType" id="RoleType" style="width: 100%;" autocomplete='off'>
                    @foreach($UserRole  as $UserRole)
                         @if($UserRole->sys_user_role_id == $user->sys_user_role_id)
                            <option selected value="{{ $UserRole->sys_user_role_id }}">{{ $UserRole->sys_user_role }}</option>
                          @else
